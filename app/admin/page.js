...
export default function AdminPage() {
  ...
  const TAB_META = {
    ...
    inquiries: {
      title: "Inquiries",
      sub: newInquiriesCount > 0 ? `${newInquiriesCount} new` : "All read",
    },
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 36,
                          borderRadius: 8,
                          background: "rgba(161,117,252,0.08)",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                        }}
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setForm({
                          ...form,
                          parcel_panel_api_key: e.target.value,
                        })
                      }
                      ...
                      <form onSubmit={handleBroadcast}>
                        ...
                        >
                          {["Media Buying", "Creative Strategy", "Supply Chain", "Customer Service", "Email Marketing", "Analytics"].map((t) => (
                            <button
                              key={t}
                              type="button"
                              className={`ap-topic-pill${broadcastForm.topic === t ? " selected" : ""}`}
                              onClick={() =>
                                setBroadcastForm({
                                  ...broadcastForm,
                                  topic: broadcastForm.topic === t ? "" : t,
                                })
                              }
                            >
                              {t}
                        ...
                        {broadcastForm.type === "video" && (
                          <div style={{ marginBottom: 14 }}>
                            ...
                            <input
                              className="ap-input"
                              value={broadcastForm.youtube_url}
                              onChange={(e) =>
                                setBroadcastForm({
                                  ...broadcastForm,
                        ...
                        <textarea
                          ...
                          required={broadcastForm.type !== "video"}
                      ...
                      return (
                        ...
                        >
                          {bYtId ? (
                            ...
                            >
                              <img
                                src={`https://img.youtube.com/vi/${bYtId}/mqdefault.jpg`}
                                alt=""
                                style={{
                                  width: "100%",
                                  height: "100%",
                          ...
                          <button
                            onClick={() => togglePin(b.id, b.is_pinned)}
                            title={b.is_pinned ? "Unpin" : "Pin"}
                            style={{
                              background: "none",
                              border: "none",
                              color: b.is_pinned ? "#D97706" : "#9CA3AF",
                              cursor: "pointer",
                              padding: "4px",
                              borderRadius: 5,
                              flexShrink: 0,
                      ...
                      {[
                        ...
                        <button
                          ...
                          style={{
                            ...
                            fontWeight: 600,
                            cursor: "pointer",
                            color: notifForm.type === t ? "#7C3AED" : "#6B7280",
                            fontFamily: "inherit",
                          }}
                        >
                          {label}
          ...
          {activeTab === "inquiries" &&
            (() => {
              const SERVICE_COLORS = {
                "Customer Service Agent": "#7C3AED",
                "Dispute Manager": "#059669",
                "Supply Chain Manager": "#2563EB",
                "Senior Backend Manager": "#D97706",
                "Train Your Existing Team": "#EA580C",
                "General Inquiry": "#7C3AED",
              };
                      ...
                      {inquiries.map((inq) => {
                        ...
                        return (
                          <div
                            ...
                            style={{
                              background: "#FFFFFF",
                              border: `1px solid ${isNew ? "rgba(239,68,68,0.15)" : "rgba(0,0,0,0.07)"}`,
                              borderRadius: 10,
                              padding: "16px 18px",
                              display: "flex",
                              gap: 14,
                          ...
                          >
                            ...
                            <div style={{ flex: 1, minWidth: 0 }}>
                              ...
                              >
                                ...
                                {inq.phone_number && (
                                  <a
                                    href={`https://wa.me/${inq.phone_number.replace(/\D/g, "")}`}
                                    target="_blank"
                      ...
                      {["developer", "manager"].map((r) => (
                        <button
                          ...
                          style={{
                            ...
                            fontWeight: 600,
                            cursor: "pointer",
                            color: teamForm.role === r ? "#7C3AED" : "#6B7280",
                            fontFamily: "inherit",
                          }}
                        >
                ...
                {teamMembers.map((m) => (
                  <div key={m.id} className="ap-client-row">
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      ...
                      <button
                        onClick={() => deleteTeamMember(m.id, m.email)}
                        style={{
                          background: "none",
                          border: "none",
                          color: "#9CA3AF",
                ...
                <div>
                  ...
                  >
                    <div style={{ display: "flex", gap: 6 }}>
                      {[
                        ...
                        <button
                          key={id}
                          className={`ap-filter-btn${timeFilter === id ? " active" : ""}`}
                          onClick={() => {
                            setTimeFilter(id);
                            fetchTimeData(id);
                          }}
                  ...
                  >
                    {[
                      ...
                      {
                        label: "Sessions",
                        value: sessions.filter((s) => s.clocked_out_at).length,
                        color: "#0F0F10",
                        sub: null,
                      },
                      {
                          ...
                          >
                            {members.map((m) => (
                              <div
                                ...
                                style={{
                                  background: "#F9F9FB",
                                  border: `1px solid ${m.is_paused ? "rgba(217,119,6,0.2)" : m.is_active ? "rgba(16,185,129,0.15)" : "rgba(0,0,0,0.07)"}`,
                                  borderRadius: 9,
                                  padding: "12px 14px",
                                }}
                              >
                      ...
                      >
                        {[
                          ...
                          },
                          {
                            ...
                            value: fmtE(f.totalCostMonth),
                            color: "#0F0F10",
                            sub: `Fixed €${f.fixedCosts} + AI $${f.aiCostMonth.toFixed(4)}`,
                          },
                          {
                            label: "Net margin",
                            value: fmtE(f.netMargin),
                            color: f.netMargin >= 0 ? "#059669" : "#EF4444",
                            sub: `${f.marginPct}% of MRR`,
                          },
                          {
                            label: "AI costs today",
                            value: fmt(ai.today.cost),
                            color: "#0F0F10",
                              ...
                              >
                                <div>
                                  ...
                                  {tokens != null && (
                                    ...
                                    >
                                      {fmtN(tokens)} tokens · {calls} calls
                                    </div>
                                  )}
                                  ...
                                  >
                                    <div
                                      style={{
                                        ...
                                        background: "#7C3AED",
                                        borderRadius: 2,
                                        width: `${Math.min(100, (v.calls / Math.max(...Object.values(ai.byRoute).map((r) => r.calls))) * 100)}%`,
                                        opacity: 0.6,
                                      }}
                                    />
                                  </div>
                            ...
                            {finance.subscriptions.map((sub) => (
                              ...
                              >
                                ...
                                <div
                                  style={{
                                    fontWeight: 700,
                                    color: sub.cost > 0 ? "#D97706" : "#9CA3AF",
                                    fontSize: 13,
                                  }}
                                >
                    ...
                    {masterclasses.map((mc) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <div
                              style={{
                                fontSize: 18,
                                fontWeight: 800,
                                color: past ? "#9CA3AF" : "#7C3AED",
                                lineHeight: 1,
                              }}
                            >
                              {new Date(mc.scheduled_at).getDate()}
                            </div>
                            <div
                              style={{
                                fontSize: 9,
                          ...
                          <button
                            onClick={() => deleteMasterclass(mc.id)}
                            style={{
                              background: "none",
                              border: "none",
                              color: "#9CA3AF",
