...
export function AdminLogRow({ session: s }: AdminLogRowProps) {
  return (
    <div className="grid cursor-default grid-cols-[130px_110px_60px_60px_70px_1fr] items-start gap-3 border-b border-black/5 px-4.5 py-2.5 transition-colors last:border-b-0 hover:bg-[#F9F8FF]">
      <div className="truncate text-[12.5px] font-semibold text-[#0F0F10]">{s.member_name}</div>
