  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[540px]">
        ...
        <div>
          <label className="text-[10.5px] font-bold tracking-[.07em] uppercase text-muted-foreground mb-[7px] block">Internal note</label>
          <textarea
            className="w-full bg-secondary border border-border rounded-[11px] px-3.5 py-[13px] text-[13.5px] text-foreground outline-none resize-y min-h-[170px]"
            value={note}
