...
export function AlertBanner({ rate, loaded }: AlertBannerProps) {
  ...
  return (
    <div className="mb-4 flex animate-fade-in items-center gap-3 rounded-[10px] border border-red-600/15 bg-gradient-to-br from-red-50 to-red-50/80 border-l-[3px] border-l-red-600 px-4 py-3">
